...
/**
	 ...
	 * @author Shay Leary
	 * @version 00
	 * @date 2005, finsihed code
	 *
	 * @author Peter Neve
	 * @version 01
	 * @date 29/08/2021 Peter Neve, Refactor
	 *
...
#define Chained_Tree				235
#define Tree						236
#define Dying_Tree					237
#define Bush						238
#define Dead_Tree					239
...
#define Current_Level_Win_Screen	265
...
#define Portal						267
		 ...
		 *
		 * This function allows images to be loaded/saved and applied to shapes
		 *
		 * @return void
		 */
void CreateTextures();
