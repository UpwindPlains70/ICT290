...
//Version: 1
//Date: 29/08/2021
//Purpose: defines all variables for textures & load/save textures
...
void CreateTextures()
{
	...
	image = tp.LoadTexture("data/kuro.raw", 1920, 1080);
	tp.CreateTexture(KURO, image, 1920, 1080);
	...
	tp.CreateTexture(Current_Level_Win_Screen, image, 641, 638);

	image = tp.LoadTexture("data/Object Textures/finalWin.raw", 641, 638);
	...
	image = tp.LoadTexture("data/Object Textures/Portal.raw", 1024, 1024);
	tp.CreateTexture(Portal, image, 1024, 1024);
	...
	image = tp.LoadTexture("data/Object Textures/Characters/WaterBoss.raw", 1024, 1024);
	tp.CreateTexture(270, image, 1024, 1024);
	...
	image = tp.LoadTexture("data/Object Textures/Characters/SummoningMage.raw", 1024, 1024);
	tp.CreateTexture(276, image, 1024, 1024);

	image = tp.LoadTexture("data/Object Textures/Characters/AirMage.raw", 1024, 1024);
	tp.CreateTexture(277, image, 1024, 1024);

	image = tp.LoadTexture("data/Object Textures/Characters/WaterMage.raw", 1024, 1024);
	...
	image = tp.LoadTexture("data/Object Textures/Characters/FireElemental.raw", 1024, 1024);
	...
	image = tp.LoadTexture("data/Object Textures/IronDoor.raw", 1024, 1024);
	tp.CreateTexture(285, image, 1024, 1024);

	image = tp.LoadTexture("data/Object Textures/Characters/LavaGoblin.raw", 1024, 1024);
	tp.CreateTexture(286, image, 1024, 1024);

	image = tp.LoadTexture("data/Object Textures/Characters/Arrow.raw", 1024, 1024);
	tp.CreateTexture(287, image, 1024, 1024);

	image = tp.LoadTexture("data/Object Textures/Characters/mage.raw", 1024, 1024);
